...
<head>
    ...
    <meta name="description"
        content="Choose your role in CittaLoka. Register as a Host to share your culture, or a Traveler to discover authentic experiences.">
    ...
    <div class="auth-wrap">
        ...
        <div class="auth-form">
            <div class="auth-form-inner" x-data="{ role: '' }">
                ...
                <div class="role-grid">
                    {{-- Host Card --}}
                    <div class="role-card" :class="{ 'selected': role === 'host' }" @click="role = 'host'">
                    ...
                    {{-- Traveler Card --}}
                    <div class="role-card" :class="{ 'selected': role === 'user' }" @click="role = 'user'">
                ...
                <form method="POST" action="{{ route('register.set-role') }}">
                    ...
                    <button type="submit" class="btn-primary" :disabled="!role">
                        Continue as <span
                            x-text="role === 'host' ? 'Host' : (role === 'user' ? 'Traveler' : '...')"></span>
