...
<body class="min-h-screen flex items-center justify-center" style="background: #FAFAF8; font-family: 'DM Sans', sans-serif;">
...
<div class="w-full text-center px-8" style="max-width: 480px;">
    ...
    <p class="text-xs font-medium uppercase tracking-widest mb-3"
       style="color: #C4783A; letter-spacing: 0.15em;">Almost there!</p>

    <h1 class="font-normal mb-4"
        style="font-family: 'Playfair Display', serif; font-size: 32px; color: #1a2e1c;">
        Check your email
    </h1>
