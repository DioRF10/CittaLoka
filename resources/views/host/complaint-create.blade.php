...
@section('content')
    ...
    <div style="max-width:640px;">
        ...
        <div
            ...
            <div>
                <div style="font-size:0.92rem; font-weight:500; color:#1E3A2F;">{{ $booking->experience_title_snapshot }}
                </div>
                <div style="font-size:0.75rem; color:#7A7A6E;">{{ $booking->user->name }} ·
        ...
        <form action="{{ route('host.complaints.store', $booking->kode_booking) }}" method="POST"
            ...
            {{-- Deskripsi --}}
            <div style="margin-bottom:1.25rem;">
                <label style="display:block; font-size:0.85rem; font-weight:500; color:#1E3A2F; margin-bottom:0.5rem;">Tell
                    us the details</label>
