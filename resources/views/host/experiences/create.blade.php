...
@section('content')
    ...
    <div class="form-container" x-data="experienceForm()">
        ...
        @if($errors->any())
            <div
                style="background:#FEF2F2; border:1.5px solid #FCA5A5; color:#991B1B; padding:1.25rem; border-radius:16px; margin-bottom:1.5rem; box-shadow: 0 4px 12px rgba(220,38,38,0.05);">
        ...
        <form method="POST" action="{{ route('host.experiences.store') }}" enctype="multipart/form-data" id="experienceForm"
            ...
            {{-- STEP 1: Basic Info --}}
            <div x-show="currentStep === 1" x-transition:enter="fade-enter-active"
                x-transition:enter-start="fade-enter-from" x-transition:enter-end="opacity-100 transform-none">
                <div class="form-card">
                    <div class="form-card-header">
                        <h2 class="form-card-title">Basic Information</h2>
                        <p class="form-card-desc">Give your experience a catchy title and select the most fitting category.
                        </p>
                    </div>
                    <div class="form-card-body">
                        <div class="form-grid">
                            <div class="form-group">
                                <label class="form-label">Experience Title <span class="req">*</span></label>
                                <input type="text" name="judul_id" class="form-control"
                                    placeholder="e.g. Traditional Batik Class in Ubud" value="{{ old('judul_id') }}"
                                    required>
                                <p class="form-hint">English version will be translated automatically later.</p>
                            </div>
                        </div>
                ...
                <div class="form-card">
                    <div class="form-card-header">
                        ...
                        <p class="form-card-desc">Describe what makes your experience unique and why guests will love it.
                        </p>
                    </div>
                    <div class="form-card-body">
                        <div class="form-grid">
                            <div class="form-group">
                                ...
                                <textarea name="deskripsi_id" class="form-control"
                                    placeholder="Tell about this experience in English...">{{ old('deskripsi_id') }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- STEP 2: Details --}}
            <div x-show="currentStep === 2" style="display:none;" x-transition:enter="fade-enter-active"
                x-transition:enter-start="fade-enter-from" x-transition:enter-end="opacity-100 transform-none">
                <div class="form-card">
                    <div class="form-card-header">
                    ...
                    <div class="form-card-body">
                        <div class="form-grid form-grid-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="durasi_menit" class="form-control" placeholder="e.g. 120"
                                    min="30" value="{{ old('durasi_menit') }}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Min Guests <span class="req">*</span></label>
                                <input type="number" name="kapasitas_min" class="form-control" placeholder="1" min="1"
                                    value="{{ old('kapasitas_min', 1) }}" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Max Guests <span class="req">*</span></label>
                                <input type="number" name="kapasitas_max" class="form-control" placeholder="10" min="1"
                ...
                <div class="form-card">
                    ...
                    <div class="form-card-body">
                            ...
                            <template x-for="(item, index) in whatYouDo" :key="index">
                                <div class="dynamic-item">
                                    <div class="form-group" style="flex:1;">
                                        <input type="text" :name="`what_you_do[${index}][title]`" x-model="item.title"
                                            class="form-control" placeholder="Activity title (e.g. Welcome & Tea)">
                                    </div>
                                    <div class="form-group" style="flex:2;">
                                        <input type="text" :name="`what_you_do[${index}][desc]`" x-model="item.desc"
                                            class="form-control" placeholder="Brief description of the activity">
                                    </div>
                                    <button type="button" class="btn-remove" @click="whatYouDo.splice(index, 1)"
                                        x-show="whatYouDo.length > 1" title="Remove activity">
                                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <button type="button" class="btn-add"
                            @click="if(whatYouDo.length < 4) whatYouDo.push({title:'',desc:''})" style="margin-top: 1rem;">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
            ...
            {{-- STEP 3: Photos --}}
            <div x-show="currentStep === 3" style="display:none;" x-transition:enter="fade-enter-active"
                x-transition:enter-start="fade-enter-from" x-transition:enter-end="opacity-100 transform-none">
                <div class="form-card">
                    <div class="form-card-header">
                    ...
                    <div class="form-card-body">
                        <div class="upload-zone" @click="$refs.photoInput.click()" x-show="photos.length < 8">
                            ...
                            <h3 style="font-size:1.1rem; font-weight:600; color:var(--text-main); margin:0 0 0.5rem;">Click
                                to upload photos</h3>
                            <p style="font-size:0.875rem; color:var(--text-muted); margin:0;">JPG, PNG, WEBP (Max 5MB per
                                file)</p>
                        </div>

                        {{-- Temp visible input for selecting --}}
                        <input type="file" multiple accept="image/*" x-ref="photoInput" @change="handlePhotoUpload($event)"
                            style="display:none;">
                        <input type="hidden" name="cover_index" x-model="coverIndex">

                        <div class="photo-grid" x-show="photos.length > 0">
                            <template x-for="(photo, index) in photos" :key="index">
                                <div class="photo-item" :class="coverIndex === index ? 'is-cover' : ''"
                                    @click="coverIndex = index">
                                    <img :src="photo.preview" alt="Experience Photo">
                                    <div class="badge-cover" x-show="coverIndex === index">Cover Photo</div>
                                    <button type="button" class="btn-remove-photo" @click.stop="removePhoto(index)"
                                        title="Remove photo">
                        ...
                        <div x-show="photos.length > 0"
                            style="margin-top:1.5rem; padding:1rem; background:var(--primary-soft); border-radius:12px; display:flex; align-items:center; gap:0.75rem; color:var(--primary-light);">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2">
                                <circle cx="12" cy="12" r="10" />
                            ...
                            <span style="font-size:0.9rem; font-weight:500;">Click on any uploaded photo to set it as the
                                primary cover photo. (<span x-text="photos.length"></span>/8 uploaded)</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div x-show="currentStep === 4" style="display:none;" x-transition:enter="fade-enter-active"
                x-transition:enter-start="fade-enter-from" x-transition:enter-end="opacity-100 transform-none">
                <div class="form-card">
                    <div class="form-card-header">
                    ...
                    <div class="form-card-body">
                        <div class="form-group" style="max-width: 400px;">
                            ...
                            <div style="position:relative; display:flex; align-items:center;">
                                <span
                                    style="position:absolute; left:1.25rem; font-weight:600; color:var(--text-muted);">Rp</span>
                                <input type="number" name="harga" class="form-control"
                                    style="padding-left:3.25rem; font-size:1.1rem; font-weight:600;" placeholder="350000"
                                    min="1000" value="{{ old('harga') }}" required>
                            </div>
                            <p
                                style="font-size:0.85rem; color:var(--text-muted); margin-top:0.5rem; display:flex; align-items:center; gap:0.4rem;">
                            ...
                            <div>
                                ...
                                <div class="dynamic-list">
                                    <template x-for="(item, index) in included" :key="index">
                                        <div class="dynamic-item">
                                            <input type="text" :name="`included[${index}]`" x-model="included[index]"
                                                class="form-control" placeholder="e.g. Tools and materials">
                                            <button type="button" class="btn-remove" @click="included.splice(index, 1)"
                                                x-show="included.length > 1">
                                ...
                                <button type="button" class="btn-add" @click="included.push('')"
                                    style="margin-top: 0.5rem;">+ Add Inclusion</button>
                            </div>

                            {{-- Not Included --}}
                            <div>
                                <label class="form-label"
                                    style="margin-bottom:1rem; display:flex; align-items:center; gap:0.5rem; color:var(--accent);">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                        stroke-width="2">
                                        <line x1="18" y1="6" x2="6" y2="18" />
                                        <line x1="6" y1="6" x2="18" y2="18" />
                                ...
                                <div class="dynamic-list">
                                    <template x-for="(item, index) in notIncluded" :key="index">
                                        <div class="dynamic-item">
                                            <input type="text" :name="`not_included[${index}]`" x-model="notIncluded[index]"
                                                class="form-control" placeholder="e.g. Transportation">
                                            <button type="button" class="btn-remove" @click="notIncluded.splice(index, 1)"
                                                x-show="notIncluded.length > 1">
                                                <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                    stroke="currentColor" stroke-width="2">
                                                    <line x1="18" y1="6" x2="6" y2="18" />
                                                    <line x1="6" y1="6" x2="18" y2="18" />
                                ...
                                <button type="button" class="btn-add" @click="notIncluded.push('')"
                                    style="margin-top: 0.5rem;">+ Add Exclusion</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {{-- STEP 5: Location --}}
            <div x-show="currentStep === 5" style="display:none;" x-transition:enter="fade-enter-active"
                x-transition:enter-start="fade-enter-from" x-transition:enter-end="opacity-100 transform-none">
                <div class="form-card">
                    <div class="form-card-header">
                    ...
                    <div class="form-card-body">
                        <div class="form-grid form-grid-2" style="margin-bottom: 1.5rem;">
                            <div class="form-group">
                                ...
                                <input type="text" name="lokasi_nama" class="form-control"
                                    placeholder="e.g. Ubud Art Studio" value="{{ old('lokasi_nama') }}" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="kabupaten" class="form-control" required>
                                    ...
                                    @foreach(['Gianyar', 'Ubud', 'Bangli', 'Badung', 'Tabanan', 'Klungkung', 'Buleleng', 'Jembrana', 'Karangasem'] as $kab)
                                        <option value="{{ $kab }}" {{ old('kabupaten') === $kab ? 'selected' : '' }}>{{ $kab }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div style="margin-bottom: 1.5rem;">
                            <label class="form-label" style="display:block; margin-bottom:0.75rem;">Pinpoint on Map <span
                                    class="req">*</span></label>
                            <p style="font-size:0.85rem; color:var(--text-muted); margin-bottom:1rem;">Click on the map to
                                set the exact location of your experience.</p>
                        ...
                        <div class="form-grid form-grid-2" style="margin-bottom: 1.5rem;">
                            <div class="form-group">
                                ...
                                <input type="number" name="lokasi_lat" class="form-control" placeholder="-8.5069" step="any"
                                    x-model="lat" @input="updateMapFromInput()" required>
                            </div>
                            <div class="form-group">
                                <label class="form-label">Longitude <span class="req">*</span></label>
                                <input type="number" name="lokasi_lng" class="form-control" placeholder="115.2625"
                                    step="any" x-model="lng" @input="updateMapFromInput()" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group" style="margin-bottom: 1.5rem;">
                            ...
                            <textarea name="alamat_lengkap" class="form-control" rows="2"
                                placeholder="Full address of the experience location...">{{ old('alamat_lengkap') }}</textarea>
                        </div>

                        <div class="form-group">
                            <label class="form-label">Meeting Point <span class="req">*</span></label>
                            <textarea name="meeting_point" class="form-control" rows="2"
                                placeholder="Instructions on where and how to meet you... e.g. In front of the main gate, look for the green umbrella.">{{ old('meeting_point') }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                {{-- Summary Notice --}}
                <div
                    style="background:#F0FDF4; border:1px solid #BBF7D0; border-radius:16px; padding:1.5rem; display:flex; gap:1rem; align-items:flex-start;">
                    <div
                        style="background:#22C55E; color:white; border-radius:50%; width:32px; height:32px; display:flex; align-items:center; justify-content:center; flex-shrink:0; margin-top:0.25rem;">
                    ...
                    <div>
                        <h4 style="font-size:1rem; font-weight:700; color:#166534; margin:0 0 0.5rem;">Ready to create your
                            experience!</h4>
                        <p style="font-size:0.9rem; color:#15803D; margin:0; line-height:1.6;">
                            Your experience will be saved as a draft. You can review all details on the next page before
                            submitting it for admin approval. Once approved, it will be live for guests to book.
                        </p>
                    </div>
                </div>
            </div>
