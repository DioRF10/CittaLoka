...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600&family=DM+Sans:wght@300;400;500;600;700&display=swap"
        rel="stylesheet">
    ...
    <style>
        * {
        ...
        .sidebar.collapsed .sidebar-nav a .link-text {
            opacity: 0;
        }
        ...
        .sidebar-bottom button.logout-btn:hover {
            background: rgba(255, 255, 255, 0.08);
            color: white;
        }

        .sidebar-bottom a svg,
        .sidebar-bottom button.logout-btn svg {
            flex-shrink: 0;
            opacity: 0.65;
        }

        .sidebar-bottom a:hover svg,
        .sidebar-bottom button.logout-btn:hover svg {
            opacity: 1;
        }

        .sidebar-bottom .link-text {
            transition: opacity 0.2s;
        }

        .sidebar.collapsed .sidebar-bottom .link-text {
            opacity: 0;
        }
        ...
        <aside class="sidebar" :class="{ 'collapsed': collapsed }">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('host.dashboard') }}"
                    class="{{ request()->routeIs('host.dashboard') ? 'active' : '' }}" data-label="Dashboard">
                ...
                <a href="{{ route('host.experiences.index') }}"
                    class="{{ request()->routeIs('host.experiences.*') ? 'active' : '' }}" data-label="My Experiences">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                ...
                <a href="{{ route('host.bookings.index') }}"
                    class="{{ request()->routeIs('host.bookings.*') ? 'active' : '' }}" data-label="Bookings">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                ...
                <a href="{{ route('host.availability.index') }}"
                    class="{{ request()->routeIs('host.availability.*') ? 'active' : '' }}" data-label="Availability">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                ...
                <a href="{{ route('host.memory-books.index') }}"
                    class="{{ request()->routeIs('host.memory-books.*') ? 'active' : '' }}" data-label="Memory Books">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                ...
                <a href="{{ route('host.reviews.index') }}"
                    class="{{ request()->routeIs('host.reviews.*') ? 'active' : '' }}" data-label="Reviews">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                        <polygon
                ...
                <a href="{{ route('host.earnings') }}" class="{{ request()->routeIs('host.earnings') ? 'active' : '' }}"
                    data-label="Earnings">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                ...
                <a href="#" class="{{ request()->routeIs('host.support') ? 'active' : '' }}" data-label="Support">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
                        <circle cx="12" cy="12" r="10" />
            ...
            <div class="sidebar-bottom">
                ...
                <a href="{{ route('host.settings') }}" class="{{ request()->routeIs('host.settings') ? 'active' : '' }}"
                    data-label="Settings">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round">
        ...
        <div class="main-content" :class="{ 'sidebar-collapsed': collapsed }">
            ...
            <header class="top-header">
                <div class="top-header-left">
                    ...
                    <button class="header-icon-btn" @click="toggle()"
                ...
                <div class="top-header-right">
                    ...
                    <a href="{{ route('host.profile.index') }}" title="My Profile">
                        <img src="{{ auth()->user()->avatarUrl() }}" alt="" class="host-avatar"
