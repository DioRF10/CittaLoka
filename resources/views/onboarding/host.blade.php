...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,400;0,500;0,600;1,400&family=DM+Sans:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .tip-box.success { background: var(--success-bg); border: 1px solid var(--success-border); }
        .tip-box.warn { background: var(--warn-bg); border: 1px solid var(--warn-border); }
        .tip-box.info { background: #EBF1F5; border: 1px solid #C9DCE8; }
        ...
        @media (max-width: 640px) {
            .ktp-upload-grid { grid-template-columns: 1fr; }
        }
        ...
        .bank-status-box.verified { background: var(--success-bg); border: 1.5px solid var(--success-border); }
        .bank-status-box.needs-review { background: var(--warn-bg); border: 1.5px solid var(--warn-border); }
        .bank-status-box.checking { background: var(--cream); border: 1.5px solid var(--gray-border); }

        .bank-status-icon { font-size: 1.1rem; flex-shrink: 0; }
        ...
        .bank-status-box.verified .bank-status-title { color: var(--success-text); }
        .bank-status-box.needs-review .bank-status-title { color: var(--terracotta); }
        .bank-status-box.checking .bank-status-title { color: var(--green-dark); }
...
<div class="onboarding-shell" x-data="onboardingHost()" x-cloak>
    ...
    <div class="left-panel">
        ...
        <template x-if="step === 1">
            <div style="display:flex; flex-direction:column; flex:1;">
                ...
                <p class="left-desc">CittaLoka membantu Anda berbagi pengetahuan dan budaya, sekaligus mendapatkan penghasilan yang adil dari setiap pengalaman yang Anda bagikan.</p>
                ...
                <div class="welcome-benefit-list">
                    <div class="welcome-benefit-item">
                        ...
                        <div>
                            ...
                            <div class="welcome-benefit-desc">Kami hanya mengambil 10% komisi untuk operasional platform.</div>
                        </div>
                    </div>
                    <div class="welcome-benefit-item">
                        <div class="welcome-benefit-icon">⚡</div>
                        <div>
                            ...
                            <div class="welcome-benefit-desc">Dana dari booking dicairkan otomatis ke rekening Anda.</div>
                        </div>
                    </div>
                    <div class="welcome-benefit-item">
                        ...
                        <div>
                            ...
                            <div class="welcome-benefit-desc">Kami memastikan setiap host berkualitas dan siap dibantu.</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style="display:flex; flex-direction:column; flex:1;">
                ...
                <div class="left-info-box">
                    ...
                    <div>
                        ...
                        <div class="left-info-text">Bahasa dan lokasi membantu kami menerjemahkan cerita Anda secara akurat, serta menampilkan pengalaman Anda ke wisatawan yang relevan.</div>
                    </div>
                </div>
        ...
        <template x-if="step === 3">
            <div style="display:flex; flex-direction:column; flex:1;">
                ...
                <p class="left-desc">Profil yang lengkap membantu wisatawan mengenal Anda dan terinspirasi dengan pengalaman yang Anda bagikan.</p>
    ...
    <div class="right-panel">
            ...
            <template x-for="(label, index) in stepLabels" :key="index">
                <template x-if="index > 0">
                    <div style="display:flex; align-items:center; flex:1;">
                        <div class="step-line" :class="{ done: step > index }"></div>
                        <div class="step-node">
                            <div class="step-circle" :class="{ done: step > index, active: step === index + 1 }">
                                <span x-show="step > index">✓</span>
                ...
                <template x-if="index === 0">
                    <div class="step-node">
                        ...
                        <div class="step-label" :class="{ 'active-label': step === 1 }" x-text="label"></div>
                    </div>
                </template>
            </template>
        </div>
        ...
        <div x-show="step === 1" class="form-card">
            ...
            <p class="form-subtitle" style="margin-bottom:1.75rem;">Sebelum memulai, mari pahami bagaimana CittaLoka bekerja dan keuntungan menjadi bagian dari kami.</p>
            ...
            <div class="welcome-benefit-list" style="margin-bottom:1.75rem;">
                <div class="welcome-benefit-item">
                    ...
                    <div>
                        ...
                        <div class="welcome-benefit-desc">Kami hanya mengambil 10% komisi yang digunakan untuk operasional platform.</div>
                    </div>
                </div>
                <div class="welcome-benefit-item">
                    <div class="welcome-benefit-icon">⚡</div>
                    <div>
                        ...
                        <div class="welcome-benefit-desc">Dana dari booking yang sudah selesai akan dicairkan otomatis tanpa perlu menunggu lama.</div>
                    </div>
                </div>
                <div class="welcome-benefit-item">
                    <div class="welcome-benefit-icon">🛡️</div>
                    <div>
                        <div class="welcome-benefit-title">Kurasi & dukungan tim</div>
                        <div class="welcome-benefit-desc">Kami memastikan setiap host berkualitas dan siap memberikan pengalaman terbaik.</div>
                    </div>
                </div>
                <div class="welcome-benefit-item">
                    <div class="welcome-benefit-icon">👥</div>
                    <div>
                        ...
                        <div class="welcome-benefit-desc">Bergabung dengan komunitas host lokal dan dapatkan promosi dari CittaLoka.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="tip-box" style="margin-bottom:1.75rem;">
                ...
                <div>
                    ...
                    <div class="tip-text">Dari memasak makanan tradisional, membuat kerajinan tangan, hingga upacara adat — semua bisa menjadi pengalaman berharga bagi wisatawan yang mencari makna.</div>
                </div>
            </div>

            <label class="checkbox-row" style="margin-bottom:1.75rem;">
                <div class="checkbox-custom" :class="{ checked: form.agreeIntro }" x-on:click="form.agreeIntro = !form.agreeIntro">
                    <span x-show="form.agreeIntro">✓</span>
                </div>
                <span class="checkbox-text">Saya sudah memahami informasi di atas dan siap menjadi Host di CittaLoka</span>
            </label>
        ...
        <div x-show="step === 2" class="form-card">
            <div class="form-header">
                ...
                <div>
                    ...
                    <p class="form-subtitle">Informasi ini membantu kami menerjemahkan konten Anda dan menampilkan pengalaman Anda kepada wisatawan yang tepat.</p>
                </div>
            </div>

            <div class="field-group">
                <label class="field-label">Bahasa Utama <span class="required">*</span></label>
                <p class="field-hint" style="margin-top:-0.2rem; margin-bottom:0.85rem;">Bahasa yang paling sering Anda gunakan saat berkomunikasi dan membuat konten.</p>

                <div class="radio-card-grid">
                    <div class="radio-card" :class="{ selected: form.locale === 'id' }" x-on:click="form.locale = 'id'">
                        <div class="radio-card-dot"><div class="radio-card-dot-inner" x-show="form.locale === 'id'"></div></div>
                        <div class="radio-card-title">Bahasa Indonesia</div>
                        <div class="radio-card-desc">Saya lebih nyaman berkomunikasi dan membuat konten dalam Bahasa Indonesia.</div>
                        <span class="badge-recommended">Disarankan</span>
                    </div>
                    <div class="radio-card" :class="{ selected: form.locale === 'en' }" x-on:click="form.locale = 'en'">
                        <div class="radio-card-dot"><div class="radio-card-dot-inner" x-show="form.locale === 'en'"></div></div>
                        <div class="radio-card-title">English</div>
                        <div class="radio-card-desc">I am more comfortable communicating and creating content in English.</div>
                    </div>
                    <div class="radio-card" :class="{ selected: form.locale === 'mix' }" x-on:click="form.locale = 'mix'">
                        <div class="radio-card-dot"><div class="radio-card-dot-inner" x-show="form.locale === 'mix'"></div></div>
                        <div class="radio-card-title">Keduanya (ID & EN)</div>
                        <div class="radio-card-desc">Saya menggunakan Bahasa Indonesia dan English secara bergantian.</div>
                    </div>
                </div>
            </div>
            ...
            <div class="field-group" style="margin-top:1.75rem;">
                ...
                <p class="field-hint" style="margin-top:-0.2rem; margin-bottom:0.85rem;">Desa atau wilayah tempat Anda tinggal dan berbagi pengalaman.</p>

                <input type="text" class="text-input" placeholder="Contoh: Desa Mas, Ubud, Gianyar" x-model="form.village" maxlength="100">
            ...
            <div class="form-actions">
                ...
                <button class="btn-next" type="button" :disabled="!form.locale || !form.village" x-on:click="saveStep(2)">
                    Lanjutkan
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </button>
            </div>
        ...
        <div x-show="step === 3" class="form-card">
            <div class="form-header">
                ...
                <div>
                    ...
                    <p class="form-subtitle">Ceritakan siapa Anda dan apa yang ingin Anda bagikan kepada wisatawan.</p>
                </div>
            </div>
            ...
            <div class="field-row field-group">
                ...
                <div>
                    ...
                    <div class="avatar-upload-row">
                        ...
                        <div>
                            <button type="button" class="btn-upload-photo" x-on:click="$refs.avatarInput.click()">Pilih Foto</button>
                            <p class="field-hint" style="margin-top:0.4rem;">JPG/PNG, maks 2MB</p>
                            <input type="file" x-ref="avatarInput" accept="image/jpeg,image/png" style="display:none;" x-on:change="previewAvatar($event)">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="field-group">
                ...
                <p class="field-hint" style="margin-top:-0.2rem; margin-bottom:0.85rem;">Pilih semua keahlian yang Anda miliki atau bagikan.</p>

                <div class="expertise-grid">
                    <template x-for="opt in expertiseOptions" :key="opt.value">
                        <div class="expertise-card" :class="{ selected: form.expertise.includes(opt.value) }" x-on:click="toggleExpertise(opt.value)">
            ...
            <div class="field-group">
                ...
                <p class="field-hint" style="margin-top:-0.2rem; margin-bottom:0.6rem;">Perkenalkan diri Anda dalam 1–2 kalimat.</p>
                <textarea class="textarea-input" rows="3" maxlength="300" x-model="form.bio" placeholder="Saya Made Sari, pengrajin anyaman bambu dari Desa Mas, Ubud..."></textarea>
            ...
            <div class="field-group">
                ...
                <p class="field-hint" style="margin-top:-0.2rem; margin-bottom:0.6rem;">Bagikan perjalanan atau pengalaman yang menginspirasi Anda.</p>
                <textarea class="textarea-input" rows="4" maxlength="500" x-model="form.story" placeholder="Sejak kecil saya belajar dari ibu dan nenek membuat anyaman bambu..."></textarea>
            ...
            <div class="tip-box">
                ...
                <div>
                    ...
                    <div class="tip-text">Profil Anda akan ditampilkan kepada wisatawan dan membantu mereka memilih pengalaman yang tepat.</div>
                </div>
            </div>
            ...
            <div class="form-actions">
                ...
                <button class="btn-next" type="button" :disabled="!form.fullName || !form.phoneNumber || form.expertise.length === 0" x-on:click="saveStep(3)">
                    Lanjutkan
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </button>
            </div>
        ...
        <div x-show="step === 4" class="form-card">
            <div class="form-header">
                ...
                <div>
                    ...
                    <p class="form-subtitle">Unggah foto KTP Anda untuk verifikasi akun Host. Proses ini membantu kami menjaga keamanan platform dan kepercayaan wisatawan.</p>
                </div>
            </div>
            ...
            <div class="tip-box info">
                ...
                <div>
                    ...
                    <div class="tip-text">Tim kami akan memeriksa dokumen Anda dan mengirimkan hasilnya melalui email.</div>
                </div>
            </div>

            <label class="field-label" style="display:block; margin-bottom:0.3rem;">Unggah KTP</label>
            <p class="field-hint" style="margin-bottom:1rem;">Pastikan foto KTP jelas, tidak buram, dan semua informasi terlihat.</p>
            ...
            <div class="ktp-upload-grid">
                <div class="ktp-card">
                    ...
                    <button type="button" class="btn-upload-ktp" x-on:click="$refs.ktpFrontInput.click()">↑ Upload Foto Depan</button>
                    <input type="file" x-ref="ktpFrontInput" accept="image/jpeg,image/png" style="display:none;" x-on:change="previewKtp($event, 'front')">
                ...
                <div class="ktp-card">
                    ...
                    <button type="button" class="btn-upload-ktp" x-on:click="$refs.ktpSelfieInput.click()">↑ Upload Foto Selfie</button>
                    <input type="file" x-ref="ktpSelfieInput" accept="image/jpeg,image/png" style="display:none;" x-on:change="previewKtp($event, 'selfie')">
                    <p class="field-hint" style="text-align:center;">Wajah & KTP terlihat jelas, JPG/PNG maks 2MB</p>
                </div>
            </div>

            <div class="info-checklist">
                <div class="info-checklist-item"><span class="check-mark">✓</span> Nama pada KTP harus sesuai dengan nama di profil Anda.</div>
                <div class="info-checklist-item"><span class="check-mark">✓</span> Pada foto selfie, pastikan wajah dan KTP yang Anda pegang terlihat jelas dan tidak terpotong.</div>
                <div class="info-checklist-item"><span class="check-mark">✓</span> Verifikasi ini tidak akan mempengaruhi privasi data Anda.</div>
                <div class="info-checklist-item"><span class="check-mark">✓</span> Anda tetap dapat melanjutkan onboarding — proses verifikasi dilakukan setelah Anda menyelesaikan semua langkah.</div>
            </div>
            ...
            <div class="tip-box info" style="margin-bottom:0;">
                ...
                <div style="flex:1;">
                    ...
                    <div class="tip-text">Jika Anda belum memiliki KTP, silakan hubungi tim kami untuk alternatif verifikasi lainnya.</div>
                </div>
                <a href="https://wa.me/6281234567890" target="_blank" class="btn-help" style="flex-shrink:0; text-decoration:none; display:inline-flex; align-items:center;">WhatsApp Kami</a>
            </div>
            ...
            <div class="form-actions">
                ...
                <button class="btn-next" type="button" :disabled="!ktpFrontFile || !ktpSelfieFile" x-on:click="saveStep(4)">
                    Lanjutkan
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                </button>
            </div>
        ...
        <div x-show="step === 5" class="form-card">
            <div class="form-header">
                ...
                <div>
                    ...
                    <p class="form-subtitle">Rekening ini digunakan untuk menerima pencairan dana dari setiap booking yang Anda terima.</p>
                </div>
            </div>
            ...
            <div class="field-row field-group">
                ...
                <div>
                    ...
                    <input type="text" class="text-input" x-model="form.bankAccountNumber" placeholder="1234567890" inputmode="numeric">
                </div>
            </div>

            <div class="field-group">
                <label class="field-label">Nama Pemilik Rekening <span class="required">*</span></label>
                <input type="text" class="text-input" x-model="form.bankAccountName" placeholder="Sesuai dengan nama di KTP">
                <p class="field-hint">Pastikan nama ini sesuai dengan nama di profil Anda untuk proses verifikasi yang lebih cepat.</p>
            </div>
            ...
            <label class="checkbox-row" style="margin-bottom:0.5rem; margin-top:0.5rem;">
                <div class="checkbox-custom" :class="{ checked: form.confirmBank }" x-on:click="form.confirmBank = !form.confirmBank">
                    <span x-show="form.confirmBank">✓</span>
                </div>
                <span class="checkbox-text">Saya menyatakan data rekening di atas sudah benar dan dapat dipertanggungjawabkan.</span>
            </label>
        ...
        <div x-show="step === 6" class="form-card completion-wrap">
            ...
            <p class="completion-sub">Selamat bergabung dengan komunitas host CittaLoka. KTP Anda sedang ditinjau — kami akan memberi tahu hasilnya dalam 24 jam melalui email.</p>
            ...
            <div class="bank-status-box needs-review" style="text-align:left;" x-show="finalBankStatus === 'needs_review'">
                <span class="bank-status-icon">⏳</span>
                <div>
                    <div class="bank-status-title">Rekening tersimpan</div>
                    <div class="bank-status-text">Tim kami akan meninjau secara singkat sebelum pencairan dana pertama. Anda tidak perlu mengulang langkah ini.</div>
                </div>
            </div>

            <p class="field-hint" style="margin-bottom:1.5rem;">Anda sudah dapat membuka dashboard sambil menunggu verifikasi KTP selesai.</p>

            <button class="btn-next" type="button" style="margin:0 auto;" x-on:click="window.location.href = dashboardUrl">
                Buka Dashboard
                <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
            </button>
        </div>
...
<a href="https://wa.me/6281234567890" target="_blank" class="floating-help">
    <span class="floating-help-icon">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="#fff"><path d="M17.6 6.32A8.86 8.86 0 0 0 12 4a8.94 8.94 0 0 0-7.92 13.08L3 21l3.92-1.04A8.94 8.94 0 0 0 12 21a8.94 8.94 0 0 0 8.94-9 8.86 8.86 0 0 0-3.34-5.68zM12 19.4a7.4 7.4 0 0 1-3.78-1.04l-.27-.16-2.32.62.62-2.26-.18-.28A7.43 7.43 0 1 1 19.4 12 7.43 7.43 0 0 1 12 19.4z"/></svg>
    </span>
