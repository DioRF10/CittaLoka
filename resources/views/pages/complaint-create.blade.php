...
<div style="background:#FAFAF8; min-height:100vh; padding-bottom:5rem;">
    <div style="max-width:640px; margin:0 auto; padding:3rem 2rem 0;">
        ...
        <a href="{{ route('bookings.show', $booking->kode_booking) }}" style="font-size:0.8rem; color:#7A7A6E; text-decoration:none; display:inline-flex; align-items:center; gap:0.3rem; margin-bottom:1.5rem;">
        ...
        <p style="font-size:0.9rem; color:#7A7A6E; margin-bottom:1.75rem;">
            Ceritakan apa yang terjadi. Tim CittaLoka akan meninjau dan menghubungi kamu kembali.
        </p>
        ...
        <form action="{{ route('complaints.store', $booking->kode_booking) }}" method="POST" enctype="multipart/form-data"
              x-data="{
                  photos: [],
                  addPhotos(e) {
