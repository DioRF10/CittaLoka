...
@push('styles')
    <style>
        ...
        *::after {
        ...
        .heritage-content.right {
            grid-column: 3;
            text-align: left;
        }

        .heritage-content.left {
            grid-column: 1;
            text-align: right;
        }
        ...
        @media (max-width: 768px) {
            ...
            .hero-photo-wrap {
                display: none;
                /* Hide on mobile to keep text focus */
            }
                    ...
                    @auth
                        @if(auth()->user()->role !== 'host')
                            <div x-data="{ following: {{ auth()->user()->isFollowing($host->id) ? 'true' : 'false' }} }"
                                data-auth="1" data-follow-url="{{ route('hosts.follow-toggle') }}" data-host-id="{{ $host->id }}"
                                data-csrf="{{ csrf_token() }}" style="display: inline-block;">
                                <button @click="
                                                following = !following;
                    ...
                    @else
                        <div style="text-align: center; line-height: 1.5;">
                            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"
                                style="margin: 0 auto 0.5rem; color:#C4A882;">
    ...
    <div class="host-page-body">
                    ...
                    <div class="info-card">
                        ...
                        <div class="info-row">
                            ...
                            <div>
                                ...
                                <div class="info-value">Indonesian, English</div>
                            </div>
                        </div>
                        ...
                        <div class="info-stats-row">
                            ...
                            <div class="info-stat">
                                <div class="stat-num">
                                    {{ $host->rating_avg > 0 ? number_format($host->rating_avg, 1) : '-' }}</div>
        ...
        <div class="heritage-section">
            <div class="host-section" style="padding-top: 0;">
                ...
                <p class="section-sub">A timeline of artistic evolution across generations of the
                    {{ explode(',', $host->village ?? 'Sudarsana')[0] }} family.</p>
                                ...
                                <div class="heritage-item">
                                    ...
                                    @if($isLeft)
                                        ...
                                        <div class="heritage-content left">
                                            <div class="heritage-year">
                                                {{ $node->learned_from_year ?? 'Gen ' . ($node->generation_number ?? $loop->iteration) }}
                                            </div>
                                            <div class="heritage-name">{{ $node->teacher_name }} [Gen
                                                {{ $node->generation_number ?? $loop->iteration }}]</div>
                                        ...
                                        <div class="heritage-photo-wrap right">
                                            @if($node->photo_url)
                                                <img src="{{ asset('storage/' . $node->photo_url) }}" alt="{{ $node->teacher_name }}"
                                                    class="heritage-photo">
                                            @else
                                                <div class="heritage-photo"
                                                    style="display:flex; align-items:center; justify-content:center;">
                                                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#D4CCC0"
                                                        stroke-width="1.5">
                                                        <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                                                        <circle cx="12" cy="7" r="4" />
                                                    </svg>
