...
@section('content')
    ...
    <style>
        ...
        .profile-tab.active {
            color: #1a2e1c;
            border-bottom: 2px solid #1a2e1c;
            background: #F7F3ED;
        }
    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
        ...
        <div x-data="{ activeTab: '{{ request('tab', 'public') }}' }">
            ...
            <div class="profile-tabs">
                <button class="profile-tab" :class="activeTab === 'public' ? 'active' : ''"
                    x-on:click="activeTab = 'public'">
                    Public Profile
                </button>
                <button class="profile-tab" :class="activeTab === 'contact' ? 'active' : ''"
                    x-on:click="activeTab = 'contact'">
                    Contach
                </button>
                <button class="profile-tab" :class="activeTab === 'security' ? 'active' : ''"
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-section-body" x-data="{ preview: null }">
                            <div style="display:flex; align-items:center; gap:1.5rem; margin-bottom:1.5rem;">
                                ...
                                <label
                                    style="display:inline-flex; align-items:center; gap:0.5rem; padding:0.6rem 1rem; border:1.5px solid #EDE7DC; border-radius:8px; cursor:pointer; font-size:0.82rem; font-weight:500; color:#1a2e1c;">
                            ...
                            <div class="form-grid-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="locale" class="form-select">
                                        <option value="id" {{ $user->locale === 'id' ? 'selected' : '' }}>🇮🇩 Indonesian
                                        </option>
                                        <option value="en" {{ $user->locale === 'en' ? 'selected' : '' }}>🇬🇧 English
                                        </option>
                                    </select>
                                </div>
                            </div>
