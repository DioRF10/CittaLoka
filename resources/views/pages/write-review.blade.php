    ...
    <div style="background:#FAFAF8; min-height:100vh; padding-bottom:5rem;">
        <div style="max-width:640px; margin:0 auto; padding:3rem 2rem 0;">
            ...
            <form action="{{ route('reviews.store', $booking->kode_booking) }}" method="POST" enctype="multipart/form-data"
                ...
                {{-- Rating bintang --}}
                <div
                    style="background:white; border:1.5px solid #EDE7DC; border-radius:12px; padding:1.5rem; margin-bottom:1.25rem; text-align:center;">
                    <label
                        style="display:block; font-size:0.85rem; font-weight:500; color:#1E3A2F; margin-bottom:0.85rem;">Berapa
                        rating kamu untuk experience ini?</label>
                ...
                <div style="margin-bottom:1.25rem;">
                    <label
                        style="display:block; font-size:0.85rem; font-weight:500; color:#1E3A2F; margin-bottom:0.5rem;">Tell
                        your experience (optional)</label>
                    <textarea name="text" rows="5" maxlength="2000"
                        placeholder="Apa yang paling kamu suka? Ada saran buat host atau traveler lain?"
                ...
                <div style="margin-bottom:1.75rem;">
                    <label
                        style="display:block; font-size:0.85rem; font-weight:500; color:#1E3A2F; margin-bottom:0.5rem;">Tambahkan
                        foto (opsional, maks 6)</label>
